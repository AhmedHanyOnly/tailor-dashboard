  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="shadow-theme-lg dark:bg-gray-dark absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:end-0 dark:border-gray-800"
      >
        <div className="mb-3 flex items-center justify-between border-b border-gray-100 pb-3 dark:border-gray-700">
          <h5 className="text-lg font-semibold text-gray-800 dark:text-gray-200">الإشعارات</h5>
          <button
        ...
        <ul className="custom-scrollbar flex h-auto flex-col overflow-y-auto">
          ...
          <li>
            ...
            >
              <span className="relative z-1 block h-10 w-full max-w-10 rounded-full">
                ...
                />
                <span className="bg-success-500 absolute end-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
              </span>

              <span className="block">
                <span className="text-theme-sm mb-1.5 block space-x-1 text-gray-500 dark:text-gray-400">
                  <span className="font-medium text-gray-800 dark:text-white/90">تيري فرانسي</span>
                  <span>طلب إذن لتعديل</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">
                    المشروع - تطبيق نغانتر
                  </span>
                </span>
          ...
          {/* أضف المزيد من الإشعارات بنفس الطريقة */}
        </ul>
