                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select
                        isMulti
                        options={[
                          { value: 'feature1', label: 'ميزة 1' },
                          { value: 'feature2', label: 'ميزة 2' },
                          { value: 'feature3', label: 'ميزة 3' },
                        ]}
                ...
                <Table>
                  ...
                  <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                    {plansQuery.data?.data.map((p: any) => (
                      <TableRow key={p.id}>
                        <TableCell className="text-theme-sm px-4 py-3 text-start text-gray-800 dark:text-gray-400">
                          {p.name}
                        </TableCell>
                        <TableCell className="text-theme-sm px-4 py-3 text-start text-gray-800 dark:text-gray-400">
                          {p.description}
                        ...
                        <TableCell className="text-theme-sm px-4 py-3 text-start text-gray-800 dark:text-gray-400">
                          {p.price_type === 'fixed' ? 'ثابت' : 'نسبة من الطلب'}
                        </TableCell>
                        <TableCell className="text-theme-sm px-4 py-3 text-start text-gray-800 dark:text-gray-400">
                          {p.value}
                        </TableCell>
